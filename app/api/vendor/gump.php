...
class GUMP
{
     ...
     */
    public static function is_valid(array $data, array $validators, $readable_errors = false)
    {
    ...
    */
    ...
    /**
     * Determine if the provided value contains only numbers with dashes
     *
     * Usage: '<index>' => 'numeric_dash'
     *
     * @param string $field
     * @param array  $input
     * @param null   $param
     ...
     * @return mixed
     */
    protected function validate_numeric_dash($field, $input, $param = null)
    {
    ...
    protected function validate_href($field, $input, $param = null){
    ...
    protected function validate_freetext($field, $input, $param = null){

        if (!preg_match("/^[+a-z0-9\s\-()&_]*$/i", $input[$field]) !== false) {
            return array(
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
